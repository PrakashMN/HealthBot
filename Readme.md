...
An AI-driven public health chatbot designed to empower rural and semi-urban communities with intelligent and accessible healthcare assistance.
...
* **Multilingual Support**: Native support for Hindi, English, Bengali, Tamil, Telugu, and Marathi with automatic language detection AI-Driven Public Health Chatbot - Comprehensive Sy....html].
...
4.  Open your web browser and navigate to `http://localhost:80` (or the port you've configured for the frontend) to see the application running.
